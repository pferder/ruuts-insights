  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-center mb-6">
        <Leaf className="h-12 w-12 text-farm-green-600" />
      </div>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="col-span-full">
              ...
              <FormDescription>
                {t("farmWizard.grassTypesDesc", "Enter the grass and forage species in your pastures, separated by commas.")}
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>
                {t("farmWizard.soilHealthScoreDesc", "Estimate the current soil health on a scale of 1-10.")}
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>
                {t("farmWizard.forageDensityDesc", "Estimate the current forage production in kg per hectare.")}
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}

  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-center mb-6">
        <BarChart className="h-12 w-12 text-farm-green-600" />
      </div>
              ...
              <FormControl>
                ...
                >
                  <div className="flex items-center space-x-2">
                    ...
                    <label htmlFor="dairy" className="text-sm cursor-pointer">{t("farmWizard.dairy", "Dairy")}</label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="livestock" id="livestock" />
                    <label htmlFor="livestock" className="text-sm cursor-pointer">{t("farmWizard.livestock", "Livestock")}</label>
                  </div>
                </RadioGroup>
              </FormControl>
              <FormMessage />
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>
                {t("farmWizard.supplementationDesc", "Average amount of supplementary feed per animal per day")}
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}

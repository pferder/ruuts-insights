...
export function FarmWizard() {
  ...
  const renderStepContent = () => {
    switch (currentStep) {
      case 0:
        return <GeneralInfoStep form={form} onGeoFileUpload={handleGeoFileUpload} />;
      case 1:
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          {t("farmWizard.description", "Add information about your farm to get started with regenerative insights.")}
        </CardDescription>
      </CardHeader>
